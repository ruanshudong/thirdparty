...
if (WIN32)
    ...
    ExternalProject_Add(ADD_${LIB_MYSQL}
            ...
            CONFIGURE_COMMAND ${CMAKE_COMMAND} .  -DCMAKE_CXX_FLAGS=${MT_MODE_FLAG} -T${MSVC_TOOLSET_VERSION} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/mysql-${MYSQL_VERSION} -DBUILD_CONFIG=mysql_release -DDISABLE_SHARED=${DISABLE_SHARED}
