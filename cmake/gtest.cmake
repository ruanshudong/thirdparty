...
if (WIN32)
  ...
  ExternalProject_Add(ADD_${LIB_GTEST}
          ...
          CONFIGURE_COMMAND ${CMAKE_COMMAND} . -T${MSVC_TOOLSET_VERSION} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/gtest-${GTEST_VERSION} -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} -Dgtest_hide_internal_symbols=ON -Dgtest_force_shared_crt=ON -Dgtest_force_shared_crt=on
