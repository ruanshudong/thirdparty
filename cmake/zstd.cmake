...
ExternalProject_Add(ADD_${LIB_ZSTD}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} ${THIRDPARTY_PATH}/${LIB_ZSTD}-lib/build/cmake  -DCMAKE_CXX_FLAGS=${MT_MODE_FLAG} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_ZSTD}-${ZSTD_VERSION} -DZSTD_BUILD_SHARED=${BUILD_SHARED_LIBS} -DZSTD_BUILD_STATIC=${BUILD_STATIC_LIBS} -DCMAKE_POSITION_INDEPENDENT_CODE=ON
