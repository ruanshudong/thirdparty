...
ExternalProject_Add(ADD_${LIB_TALIB}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} .  -DCMAKE_CXX_CFLAGS=${MT_MODE_FLAG} -T${MSVC_TOOLSET_VERSION}  -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_TALIB}-${TALIB_VERSION}
...
if(MSVC)
set(LINK_DST "${CMAKE_INSTALL_PREFIX}\\\\talib")
set(LINK_SRC "${CMAKE_INSTALL_PREFIX}\\\\talib-${TALIB_VERSION}")
