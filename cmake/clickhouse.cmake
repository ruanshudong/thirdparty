...
if (UNIX)
    ...
    ExternalProject_Add(ADD_${LIB_CLICKHOUSE}
            ...
            CONFIGURE_COMMAND ${CMAKE_COMMAND} ${THIRDPARTY_PATH}/${LIB_CLICKHOUSE}-lib -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_CLICKHOUSE}-version -DBUILD_SHARED_LIBS=OFF
