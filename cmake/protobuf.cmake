...
ExternalProject_Add(ADD_${LIB_PROTOBUF}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} cmake  -DCMAKE_CXX_FLAGS=${MT_MODE_FLAG} -T${MSVC_TOOLSET_VERSION} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_PROTOBUF}-${PROTOBUF_VERSION} -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} -Dprotobuf_BUILD_TESTS=OFF
