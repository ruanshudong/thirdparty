...
ExternalProject_Add(ADD_${LIB_RDKAFKA}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} .   -DCMAKE_CXX_CFLAGS=${MT_MODE_FLAG} -T${MSVC_TOOLSET_VERSION}  -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_RDKAFKA}-${RDKAFKA_VERSION} -DCMAKE_PREFIX_PATH=${CMAKE_PREFIX_PATH} -DRDKAFKA_BUILD_STATIC=${BUILD_STATIC_LIBS} -DWITH_ZLIB=OFF -DWITH_ZSTD=OFF -DWITH_LZ4_EXT=OFF -DENABLE_LZ4_EXT=OFF -DWITH_CURL=OFF -DWITH_SASL=OFF -DRDKAFKA_BUILD_TESTS=OFF -DRDKAFKA_BUILD_EXAMPLES=OFF
