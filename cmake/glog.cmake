...
ExternalProject_Add(ADD_${LIB_GLOG}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} .  -DCMAKE_CXX_FLAGS=${MT_MODE_FLAG} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_GLOG}-${GLOG_VERSION} -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS}  -DBUILD_STATIC_LIBS=${BUILD_STATIC_LIBS} -DBUILD_TESTING=OFF
