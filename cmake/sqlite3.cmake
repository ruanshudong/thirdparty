...
ExternalProject_Add(ADD_${LIB_SQLITE3}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} ${THIRDPARTY_PATH}/${LIB_SQLITE3}-lib -DCMAKE_CXX_CFLAGS=${MT_MODE_FLAG} -T${MSVC_TOOLSET_VERSION} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_SQLITE3}-${SQLITE3_VERSION} -DCMAKE_POSITION_INDEPENDENT_CODE=ON
