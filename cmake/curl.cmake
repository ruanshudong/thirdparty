...
ExternalProject_Add(ADD_${LIB_CURL}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} . -T${MSVC_TOOLSET_VERSION} -DCMAKE_CXX_CFLAGS=${MT_MODE_FLAG} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_CURL}-${CURL_VERSION} -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} -DBUILD_STATIC_LIBS=${BUILD_STATIC_LIBS} -DCMAKE_POSITION_INDEPENDENT_CODE=ON -DCMAKE_USE_OPENSSL=OFF
...
if(MSVC)
set(LINK_DST "${CMAKE_INSTALL_PREFIX}\\\\curl")
set(LINK_SRC "${CMAKE_INSTALL_PREFIX}\\\\curl-${CURL_VERSION}")
...
# INSTALL(CODE "EXECUTE_PROCESS(COMMAND cmd /c mklink /J ${CMAKE_INSTALL_PREFIX}/curl ${CMAKE_INSTALL_PREFIX}/curl-${CURL_VERSION} )")
else(MSVC)
INSTALL(CODE "EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} -E create_symlink ${CMAKE_INSTALL_PREFIX}/curl-${CURL_VERSION} ${CMAKE_INSTALL_PREFIX}/curl)")
endif(MSVC)
