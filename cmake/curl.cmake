...
if(MSVC)
INSTALL(CODE "EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} -E remove_directory ${CMAKE_INSTALL_PREFIX}/curl && ${CMAKE_COMMAND} -E copy_directory ${CMAKE_INSTALL_PREFIX}/curl-${CURL_VERSION} )")
else(MSVC)
