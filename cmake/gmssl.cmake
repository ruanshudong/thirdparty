...
if(MSVC)
set(LINK_DST "${CMAKE_INSTALL_PREFIX}\\\\gmssl")
set(LINK_SRC "${CMAKE_INSTALL_PREFIX}\\\\gmssl-${GMSSL_VERSION}")
...
# INSTALL(CODE "EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} -E remove_directory ${CMAKE_INSTALL_PREFIX}/gmssl && ${CMAKE_COMMAND} -E copy_directory ${CMAKE_INSTALL_PREFIX}/gmssl-${GMSSL_VERSION} )")
else(MSVC)
