...
ExternalProject_Add(ADD_${LIB_GFLAGS}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} . -T${MSVC_TOOLSET_VERSION} -DCMAKE_CXX_FLAGS=${MT_MODE_FLAG} -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_GFLAGS}-${GFLAGS_VERSION}
