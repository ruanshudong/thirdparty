...
ExternalProject_Add(ADD_${LIB_LZ4}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} build/cmake -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_LZ4}-${LZ4_VERSION} -DBUILD_STATIC_LIBS=ON -DLZ4_POSITION_INDEPENDENT_LIB=ON
