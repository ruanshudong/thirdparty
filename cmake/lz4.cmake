...
ExternalProject_Add(ADD_${LIB_LZ4}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} build/cmake  -DCMAKE_CXX_FLAGS=${MT_MODE_FLAG} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_LZ4}-${LZ4_VERSION} -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} -DBUILD_STATIC_LIBS=${BUILD_STATIC_LIBS} -DLZ4_POSITION_INDEPENDENT_LIB=ON -DLZ4_BUILD_CLI=OFF
