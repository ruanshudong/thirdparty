...
ExternalProject_Add(ADD_${LIB_PYBIND11}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} .  -DCMAKE_CXX_FLAGS=${MT_MODE_FLAG} -T${MSVC_TOOLSET_VERSION} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_PYBIND11}-${PYBIND11_VERSION} -DPYBIND11_TEST=OFF
