...
ExternalProject_Add(ADD_${LIB_EIGEN}
        ...
        CONFIGURE_COMMAND ${CMAKE_COMMAND} ${THIRDPARTY_PATH}/${LIB_EIGEN}-lib -T${MSVC_TOOLSET_VERSION} -DCMAKE_CXX_FLAGS=${MT_MODE_FLAG} -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/${LIB_EIGEN}-${EIGEN_VERSION}
