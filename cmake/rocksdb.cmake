...
ExternalProject_Add(ADD_${LIB_ROCKSDB}
		...
		CONFIGURE_COMMAND ${CMAKE_COMMAND} . -T${MSVC_TOOLSET_VERSION} -DCMAKE_BUILD_TYPE=Release -DFAIL_ON_WARNINGS=OFF -DROCKSDB_INSTALL_ON_WINDOWS=ON -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/rocksdb-${ROCKSDB_VERSION} -DPORTABLE=ON -DWITH_BENCHMARK_TOOLS=OFF -DWITH_TESTS=OFF -DWITH_TOOLS:BOOL=OFF -DWITH_SNAPPY=ON -DWITH_LZ4=ON -DWITH_ZLIB=ON  -DWITH_ZSTD=ON -DWITH_GFLAGS=ON -DROCKSDB_BUILD_SHARED=OFF -DUSE_RTTI=ON -DCMAKE_POSITION_INDEPENDENT_CODE=ON
...
ExternalProject_Add(ADD_${LIB_ROCKSDB}
		...
		PREFIX ${CMAKE_BINARY_DIR}
		INSTALL_DIR ${CMAKE_SOURCE_DIR}
		CONFIGURE_COMMAND ${CMAKE_COMMAND} . -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS=-Wno-error -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/rocksdb-${ROCKSDB_VERSION} -DCMAKE_CXX_FLAGS=-Wno-error -DPORTABLE=ON -DSnappy_DIR=${_SNAPPY_DIR} -DWITH_BENCHMARK_TOOLS=OFF -DWITH_TESTS=OFF -DWITH_TOOLS:BOOL=OFF -DWITH_SNAPPY=ON -DWITH_LZ4=ON -DWITH_ZLIB=ON  -DWITH_ZSTD=ON -DWITH_GFLAGS=ON -DROCKSDB_BUILD_SHARED=OFF -Dgflags_DIR=${_GFLAG_DIR} -DUSE_RTTI=ON -DCMAKE_POSITION_INDEPENDENT_CODE=ON
		SOURCE_DIR ${THIRDPARTY_PATH}/${LIB_ROCKSDB}-lib
		BUILD_IN_SOURCE 0
