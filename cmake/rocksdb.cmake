...
ExternalProject_Add(ADD_${LIB_ROCKSDB}
		...
		CONFIGURE_COMMAND ${CMAKE_COMMAND} -E env SNAPPY_INCLUDE=${SNAPPY_DIR}/include SNAPPY_LIB_RELEASE=${SNAPPY_DIR}/lib/snappy.lib ${CMAKE_COMMAND} .  -DCMAKE_CXX_FLAGS=${MT_MODE_FLAG} -T${MSVC_TOOLSET_VERSION} -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/rocksdb-${ROCKSDB_VERSION}  -DFAIL_ON_WARNINGS=OFF -DROCKSDB_INSTALL_ON_WINDOWS=ON -DPORTABLE=ON -DWITH_BENCHMARK_TOOLS=OFF -DWITH_TESTS=OFF -DWITH_TOOLS:BOOL=OFF -DWITH_SNAPPY=ON -DWITH_LZ4=OFF -DWITH_ZLIB=OFF  -DWITH_ZSTD=OFF -DROCKSDB_BUILD_SHARED=${BUILD_SHARED_LIBS} -DUSE_RTTI=ON -DCMAKE_POSITION_INDEPENDENT_CODE=ON
