...
ExternalProject_Add(ADD_${LIB_ROCKSDB}
		...
		CONFIGURE_COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/cmake/thridparty.inc ${THIRDPARTY_PATH}/${LIB_ROCKSDB}-lib && ${CMAKE_COMMAND} . -T${MSVC_TOOLSET_VERSION} -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${THIRDPARTY_PATH}/rocksdb-${ROCKSDB_VERSION}  -DFAIL_ON_WARNINGS=OFF -DROCKSDB_INSTALL_ON_WINDOWS=ON -DPORTABLE=ON -DWITH_BENCHMARK_TOOLS=OFF -DWITH_TESTS=OFF -DWITH_TOOLS:BOOL=OFF -DWITH_SNAPPY=ON -DWITH_LZ4=OFF -DWITH_ZLIB=OFF  -DWITH_ZSTD=OFF -DROCKSDB_BUILD_SHARED=OFF -DUSE_RTTI=ON -DCMAKE_POSITION_INDEPENDENT_CODE=ON
